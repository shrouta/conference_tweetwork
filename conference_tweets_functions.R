...
# Gets Connections (in the form of retweets, replies and mentions).  Takes a dataframe containing tweets (generated by get_conference_tweets, or other) and returns a paired edge list with tweet ID
...
# This function requires a dataframe which contains tweets that feature mentions, retweets or replies.  It can also include an account to drop (i.e. the conference twitter account) as a string.  It returns a graph object.
build_conference_network <- function(conference_connections, account_to_drop) {
  # Call in twitter connections data and merge connections and profiles
  conf_edge_list <- conference_connections[c("person_tweeting", "person_mentioned")]
